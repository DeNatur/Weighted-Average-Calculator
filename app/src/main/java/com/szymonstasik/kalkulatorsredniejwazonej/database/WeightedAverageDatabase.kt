...
abstract class WeightedAverageDatabase : RoomDatabase() {
     ...
     *
     * For example, clients can call `WeightedAverageDatabase.getInstance(context)` to instantiate
     * a new WeightedAverageDatabase.
     */
    companion object {
        /**
         ...
         */
        @Volatile
        private var INSTANCE: WeightedAverageDatabase? = null
         ...
         */
        fun getInstance(context: Context): WeightedAverageDatabase {
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(
                        ...
                        WeightedAverageDatabase::class.java,
                        "weighted_average_history_database"
                    )
